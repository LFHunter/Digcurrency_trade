...
class  BitoproExchange:
    def __init__(self):
        self.domain = "https://api.bitopro.com/v3/"
        self.request =   requests.Session()
        self.cookie = ''

    def  get_orderbook(self,coinpair,limit=20):
        #yfi_usdt
        #https://api.bitopro.com/v3/order-book/yfi_usdt?limit=20
        url = self.domain + f"order-book/{coinpair}?limit={limit}"
...
if __name__ == '__main__':
    bt = BitoproExchange()
    bt.get_orderbook("yfi_usdt",limit=15)